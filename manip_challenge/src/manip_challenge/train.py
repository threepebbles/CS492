...
def get_target_object_grasp_pose(target_object, world2base):
    ...
    pre_grasp_ps.position.z += 0.2
    return grasp_ps, pre_grasp_ps


def get_obstacles_pose(world2base):
    poses = []
    for name in obstacle_names:
        poses.append(get_target_object_pose(target_object=name, world2base=world2base))
    return poses
...
if __name__ == '__main__':
    ...
    initial_obstacles_pose = get_obstacles_pose(world2base)
    ...
    arm.gripperOpen()
    for _ in range(3):
        grasp_ps, pre_grasp_ps = get_target_object_grasp_pose(target_object='soap', world2base=world2base)
        ...
        current_obstacles_pose = get_obstacles_pose(world2base)
        if current_obstacles_pose==initial_obstacles_pose:
            print("same")
        else:
            print("error")
    ...
    #     grasp_ps, pre_grasp_ps = get_target_object_grasp_pose(target_object=target_object, world2base=world2base)
